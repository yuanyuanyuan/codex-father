...
export const DEFAULT_TASK_RETRY_POLICY = Object.freeze({
    maxAttempts: 3,
    baseDelay: 1_000,
    maxDelay: 30_000,
...
export const DEFAULT_TASK_METADATA = Object.freeze({
    source: 'cli',
    tags: [],
...
function mergeRetryPolicy(definition) {
...
function mergeMetadata(definition, environmentOverride) {
...
function resolveInitialStatus(scheduledAt, now) {
...
export function createTaskFromDefinition(definition, options = {}) {
    if (!definition.type) {
