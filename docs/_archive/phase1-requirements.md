...
### 1.1 项目背景
Codex Father 项目需要支持与 Claude Code 的完整集成，实现从任务接收到代码开发、分支管理、PR创建的全自动化工作流。

### 1.2 阶段目标
Phase 1 专注于构建核心的 Git 工作流管理能力和任务队列系统，为后续的测试和集成奠定基础。
