...
import loginApiKeySchema from '../../specs/008-ultrathink-codex-0/contracts/loginApiKey.schema.json';
import loginChatGptSchema from '../../specs/008-ultrathink-codex-0/contracts/loginChatGpt.schema.json';
import loginChatGptCompleteSchema from '../../specs/008-ultrathink-codex-0/contracts/loginChatGptComplete.schema.json';
import cancelLoginChatGptSchema from '../../specs/008-ultrathink-codex-0/contracts/cancelLoginChatGpt.schema.json';
import logoutChatGptSchema from '../../specs/008-ultrathink-codex-0/contracts/logoutChatGpt.schema.json';
import getAuthStatusSchema from '../../specs/008-ultrathink-codex-0/contracts/getAuthStatus.schema.json';
import authStatusChangeSchema from '../../specs/008-ultrathink-codex-0/contracts/authStatusChange.schema.json';
